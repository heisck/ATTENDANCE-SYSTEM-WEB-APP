    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      ...
      <div className="w-full max-w-sm rounded-lg border border-border bg-card p-6 space-y-6">
        <div className="text-center">
          <Image src="/icon1.png" alt="App logo" width={40} height={40} className="mx-auto rounded logo-mark" />
...
export default function ResetPasswordPage() {
  return (
    <Suspense
      fallback={
        <div className="flex min-h-screen items-center justify-center bg-background px-4">
          <div className="w-full max-w-sm rounded-lg border border-border bg-card p-6 flex items-center justify-center">
